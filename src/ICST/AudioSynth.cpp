...
SampleOsc::SampleOsc()
{
	csSampleOsc.Enter();					// single thread access on
	...
	instances++;
	csSampleOsc.Leave();					// single thread access off
}
...
{
	csChambFilter.Enter();					// single thread access on
	...
	instances++;
	csChambFilter.Leave();					// single thread access off
}
...
{
	csMoogFilter.Enter();					// single thread access on
	...
	instances++;
	csMoogFilter.Leave();					// single thread access off
}
...
{
	csFMOsc.Enter();						// single thread access on
	...
	instances++;
	csFMOsc.Leave();						// single thread access off
}
...
{
	csVAOsc.Enter();						// single thread access on
	...
	instances++;
	csVAOsc.Leave();						// single thread access off
}
